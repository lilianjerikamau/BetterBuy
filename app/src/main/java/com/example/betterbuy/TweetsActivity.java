    ...
    private void loadTweet() {
        ...
        TweetUtils.loadTweet(tweetId, new Callback<Tweet>() {
            ...
            public void success(Result<Tweet> result) {
                ...
                final TweetView tweetView = new TweetView(TweetsActivity.this, result.data,
            ...
            public void failure(TwitterException exception) {
                ...
                Toast.makeText(TweetsActivity.this, "Failed to show Tweet.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    final Callback<Tweet> actionCallback = new Callback<Tweet>() {
        ...
        public void failure(TwitterException exception) {
            if (exception instanceof TwitterAuthException) {
                Toast.makeText(TweetsActivity.this, "User is guest.", Toast.LENGTH_SHORT).show();
